...
ENTITY universal_8_Bit_Register IS
...
END universal_8_Bit_Register;

ARCHITECTURE Structural of universal_8_Bit_Register IS
...
BEGIN
   ...
   bit6: universal_dFF_1 port map (i_load, i_shiftLeft, i_shiftRight,i_parallelInput(6), int_oq(5),int_oq(7), i_clock, int_oq(6), int_oqBar(6));
	...
	bit0: universal_dFF_1 port map (i_load, i_shiftLeft, i_shiftRight,i_parallelInput(0), int_oq(7),int_oq(1), i_clock, int_oq(0), int_oqBar(0));
